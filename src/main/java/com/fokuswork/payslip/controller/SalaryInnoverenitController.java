...
public class SalaryInnoverenitController {
	...
	static Font boldFont = new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLD);
		...
		public static String empid = "I022";
		public static int payabledays = 31;
		public static String name = "Samli Prajapati" ;
		public static String pan ="FCPPP3614B" ;
		public static String bank = "SBI" ;
		public static String date = "11/03/2019" ;
		public static String acc = "35935436558" ;
	...
	public static       double    sal 	= 25000		;
	...
	public String m1() throws DocumentException, MalformedURLException, IOException {
		 ...
		 OutputStream file = new FileOutputStream(new File("C:\\Users\\LIPSA\\Desktop\\pdf_test\\marsam2021.pdf"));
	...
	public static PdfPTable imageTable() throws DocumentException, MalformedURLException, IOException {
        ...
        Image image = Image.getInstance("D:\\payslip\\src\\main\\resources\\images\\logo1.png");
...
/*------------------------------------------ROW 4----------------------------------------------*/
	...
	public static PdfPTable createTable12() throws DocumentException, MalformedURLException, IOException {
		...
		table.setSpacingBefore(20);
		Image image = Image.getInstance("D:\\payslip\\src\\main\\resources\\images\\footer.jpg");
		table.setWidthPercentage(70);
        PdfPCell cell = new PdfPCell(image, true);
        cell.setBorder(Rectangle.NO_BORDER);
        table.addCell(cell);
